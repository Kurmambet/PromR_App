...
```bash
uv run pyinstaller --noconfirm --clean --onefile --windowed --name "PromRApp" --hidden-import=PyQt5.sip --hidden-import=cv2 -i "C:\...\iconka.ico" video_streaming.py
```
